...
<body>
  ...
  <header>
    <nav class="navbar">
      ...
      <form class="busqueda_form busqueda_form-1" action="./V-products.php" method="post">
        <input class="busqueda" type="search" name="busqueda" placeholder="Productos" value="<?php if (isset($buscar)) {
                                                                                                echo $buscar;
                                                                                              } else {
                                                                                                $buscar = "";
                                                                                              } ?>" />
  ...
  <section class="container-seccion">
    ...
    <?php foreach ($resultado as $products) { ?>
      ...
      <div class="cont-cards-new">
        ...
        <form action="../controlador/C-cart-add.php" method="POST">
          ...
          <input type="hidden" name="product_imagen" value="<?php echo $products['imagen']; ?>">
          ...
          <div class="cont-card-detalle">
            ...
            <div class="cont-informacion-datalle">
              ...
              <form action="../controlador/C-cart-add.php" method="POST">
                ...
                <input type="hidden" name="product_imagen" value="<?php echo $cards['imagen']; ?>">
    ...
    <div class="cont-cart-ver">
      ...
      <div class="cart-total">
        ...
        <?php
          ...
          echo "<p style='color:red; font-weight: 800;'>!El monto minimo desbe ser de $min para realizar tu pedido¡</p>";
        }
        ?>
  ...
  <footer>
    ...
    <div class="copy">
      <small>&copy; 2022 <b>Agromprenx</b> - Todos los Derechos Reservados.</small>
    </div>
  </footer>
